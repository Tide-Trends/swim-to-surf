    ...
    <div className="space-y-12">
      ...
      <div className={`rounded-2xl p-6 border transition-all ${policyAgreed ? 'bg-green-50/50 border-green-200' : 'bg-[#1D1D1F]/5 border-black/5'}`}>
        ...
        <ul className="list-disc list-inside text-sm text-[#1D1D1F]/80 space-y-2 font-body marker:text-black/30 mb-6">
          ...
          <li><strong>Stripe:</strong> Your lesson times are held while you check out. After payment succeeds, your booking is confirmed and confirmation emails are sent. A small processing fee (~3.5%) is included in checkout. In person you can also use Apple Pay or a card with us.</li>
        </ul>
