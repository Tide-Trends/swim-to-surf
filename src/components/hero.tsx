    ...
    <section className="relative flex min-h-[100dvh] w-full flex-col overflow-hidden bg-[#b7ecff]">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          fill
          className="object-cover object-center scale-[1.03] brightness-110 contrast-95 saturate-110"
          sizes="100vw"
          priority
        />
      ...
      <div className="relative z-10 flex min-h-[100dvh] flex-col">
        <div className="flex flex-1 flex-col justify-center px-4 pb-12 pt-28 sm:px-6 md:px-8 md:pb-16 md:pt-32">
          ...
          <motion.div
            ...
            className="w-full max-w-xl sm:max-w-lg md:max-w-xl rounded-[1.75rem] border border-white/60 bg-white/40 px-5 py-6 shadow-[0_16px_40px_-20px_rgba(0,60,90,0.4)] backdrop-blur-sm sm:rounded-[2rem] sm:px-9 sm:py-8 md:px-10 md:py-9 md:ml-10 lg:ml-16"
          >
            <div className="text-center md:text-left text-[#07324a]">
